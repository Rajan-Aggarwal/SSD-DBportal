...
#define R__DICTIONARY_FILENAME TWaveDict
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TWaveform*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TWaveform", ::TWaveform::Class_Version(), "TWaveform.h", 20,
   ...
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::TWaveform*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TWaveform*)0x0)->GetClass(); }
   return fgIsA;
}
...
class __attribute__((annotate(R"ATTRDUMP(ROOT RTTI)ATTRDUMP"))) __attribute__((annotate(R"ATTRDUMP(ROOT RTTI)ATTRDUMP"))) __attribute__((annotate(R"ATTRDUMP(ROOT RTTI)ATTRDUMP"))) __attribute__((annotate(R"ATTRDUMP(ROOT RTTI)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$TWaveform.h")))  TWaveform;
)DICTFWDDCLS";
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("TWaveDict",
        ...
        TriggerDictionaryInitialization_TWaveDict_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
